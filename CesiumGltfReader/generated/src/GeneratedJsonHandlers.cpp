...
(??)#include <CesiumGltfReader/ExtensionKhrMaterialsSpecularReader.h>
(??)#include <CesiumJsonReader/ArrayJsonHandler.h>
(??)#include <CesiumJsonReader/JsonReader.h>
(??)
(??)#include <cassert>
...
(??)
(??)CesiumJsonReader::IJsonHandler*
(??)ExtensionKhrMaterialsSpecularJsonHandler::readObjectKey(
(??)    const std::string_view& str) {
(??)  assert(this->_pObject);
(??)  return this->readObjectKeyExtensionKhrMaterialsSpecular(
(??)      CesiumGltf::ExtensionKhrMaterialsSpecular::TypeName,
(??)      str,
(??)      *this->_pObject);
(??)}
(??)
...
(??)  std::any& value =
(??)      o.extensions
(??)          .emplace(extensionName, CesiumGltf::ExtensionKhrMaterialsSpecular())
(??)          .first->second;
(??)  this->reset(
(??)      pParentHandler,
(??)      &std::any_cast<CesiumGltf::ExtensionKhrMaterialsSpecular&>(value));
(??)}
(??)
(??)CesiumJsonReader::IJsonHandler*
(??)ExtensionKhrMaterialsSpecularJsonHandler::readObjectKeyExtensionKhrMaterialsSpecular(
(??)    const std::string& objectType,
(??)    const std::string_view& str,
...
(??)}
(??)
(??)ExtensionKhrMaterialsSpecularReader::ExtensionKhrMaterialsSpecularReader() {
(??)  registerExtensions(this->_options);
(??)}
(??)
(??)CesiumJsonReader::JsonReaderOptions&
(??)ExtensionKhrMaterialsSpecularReader::getOptions() {
(??)  return this->_options;
(??)}
(??)
(??)const CesiumJsonReader::JsonReaderOptions&
(??)ExtensionKhrMaterialsSpecularReader::getOptions() const {
(??)  return this->_options;
(??)}
(??)
(??)CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionKhrMaterialsSpecular>
(??)ExtensionKhrMaterialsSpecularReader::readFromJson(
(??)    const gsl::span<const std::byte>& data) const {
(??)  ExtensionKhrMaterialsSpecularJsonHandler handler(this->_options);
(??)  return CesiumJsonReader::JsonReader::readJson(data, handler);
(??)}
(??)
(??)CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionKhrMaterialsSpecular>
...
(??)ExtensionKhrMaterialsSpecularReader::readArrayFromJson(
(??)    const rapidjson::Value& value) const {
(??)  CesiumJsonReader::ArrayJsonHandler<
(??)      CesiumGltf::ExtensionKhrMaterialsSpecular,
